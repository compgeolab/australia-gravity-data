...
#v, t = read_GOCAD_ts(r'H:\GDP00037\Data\Geophysics\Gravity\Iso_Surfaces\Constrained\SA_Geophysics_Gravity_Inversion_Constrained_IsoSurface_2-63212.ts')
#v, t = read_GOCAD_ts(r'H:\GDP00037\Data\Geophysics\Gravity\Iso_Surfaces\Constrained\SA_Geophysics_Gravity_Inversion_Constrained_IsoSurface_2-67872.ts')
v, t = read_GOCAD_ts(r'H:\GDP00037\Data\Geophysics\Gravity\Iso_Surfaces\Constrained\SA_Geophysics_Gravity_Inversion_Constrained_IsoSurface_2-64896.ts')
...
#print(surf2.faces.shape)
surf2.plot(cpos=[-1, 4, 5], cmap="viridis",scalars=v, show_bounds=True)

#print(surf2)

print(t.min(axis=0), t.max(axis=0))
